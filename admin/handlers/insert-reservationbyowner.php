...
if (empty($errors)){
   ...
   echo "done";
    ...
    $sql="INSERT INTO reservations(event_type, number_guests,date,start_time, end_time, notes, hall_id,user_id,status,price) 
    VALUES ('$type','$number_of_guests','$newDate','$start_time','$end_time','done by owner','$shallId','$userId','approved','$price')";
...
$_SESSION['errors']=$errors;
  header("Refresh:0;URL=../AddReservations.php?hallId=$shallId");
