        ...
        <div class="container">
            ...
            <div class="row d-flex justify-content-center align-items-center text-center">
                <div class="col-lg-8">
                    ...
                    <h2 class="breadcrumb-title wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay=".2s">Wedding Halls</h2>
...
<div class="room-suits-page-2 pt-120 mb-120">
     <div class="container">
        <form action="weddinghalls.php" method="post"> 
          <div class="row mb-70">
                <div class="col-12">
...
if(isset($_POST['cities'])){
  ...
  //  print_r ($_POST['cities']);
    $city=$_POST['cities'];
    $sql1="SELECT * FROM halls where type='1'  and city='$city' and status='approved'";
            ...
            <div class="swiper-slide">
                <div class="single-room">
                    ...
                    <div class="room-content">
                        ...
                        <h3><a href="hall.php?hallId=<?= $hall['id'];?>"><?php echo $hall['name']?></a></h3>
